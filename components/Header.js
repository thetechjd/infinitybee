        ...
        <div className='flex h-full items-center justify-center max-w-11xl mx-auto border-opacity-0'>
          ...
          text-white md:flex'>{props.translate("about")}</p>
                ...
                {(about || amenu) &&(
                    ...
                    <a href='#roadmap'><div className='flex w-full justify-between bg-lavender bg-opacity-60 bg-lavender text-sm hover:bg-blue-300 my-1 px-4 py-2 whitespace-nowrap'>Roadmap</div></a>
                    ...
                    <a href="#faq"><div className='flex w-full justify-between bg-lavender bg-opacity-60 bg-lavender text-sm hover:bg-blue-300 my-1 px-4 py-2 whitespace-nowrap'>FAQ</div></a>
